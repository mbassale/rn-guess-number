...
const StartGameScreen = props => {
  ...
  const confirmInputHandler = () => {
    ...
    if (isNaN(chosenNumber) || chosenNumber <= 0 || chosenNumber > 99) {
      Alert.alert('Invalid number!', 'Number has to be a number beetween 1 and 99', [{
        text: 'Okay',
        style: 'destructive',
    ...
    <TouchableWithoutFeedback onPress={() => Keyboard.dismiss()}>
      <View style={styles.screen}>
        ...
        <Card style={styles.inputContainer}>
          ...
          <Input style={styles.input} blurOnSubmit autoCapitalize='none' autoCorrect={false} keyboardType='number-pad'
          ...
          <View style={styles.buttonContainer}>
            ...
            <View style={styles.button}><Button color={Colors.primary} title="Confirm"
